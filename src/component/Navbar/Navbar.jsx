    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            ...
            <div className="navbar-end">
                {
                    user ?
                        <button onClick={handleLogOut}><a className="btn bg-primary-gradient px-8">Log-Out</a></button>
                        : <Link to={"/login"}><a className="btn  bg-primary-gradient px-8">LogIn</a></Link>
                }
            </div>
        </div>
    );
